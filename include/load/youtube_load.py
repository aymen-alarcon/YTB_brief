...
def create_staging_table():
    ...
    cursor.execute("""
        DROP TABLE IF EXISTS youtube_staging_videos CASCADE;
    """)

    cursor.execute("""
        CREATE TABLE youtube_staging_videos (
            video_id VARCHAR(50) PRIMARY KEY,
            channel_id VARCHAR(100),
            channel_title TEXT,
            title TEXT,
...
def load_staging_table(videos):
    ...
    for video in videos:
        ...
        cursor.execute("""
            INSERT INTO youtube_staging_videos (
                video_id,
                channel_id,
                channel_title,
                title,
